...
beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
    yield mongoose_1.default.connect("mongodb://localhost:27017/movieapp");
}));
    ...
    describe("Post routes", () => {
        ...
        describe("get routes", () => {
            ...
            it("get  products should return 200", () => __awaiter(void 0, void 0, void 0, function* () {
                yield (0, supertest_1.default)(app_1.default).get("/users/getall");
                expect(200);
            }));
            //get product for a user
            it("get product for a user", () => __awaiter(void 0, void 0, void 0, function* () {
                const _id = "638fb1a6470e38f51ba5bef2";
                yield (0, supertest_1.default)(app_1.default).get(`/users/${_id}`);
                expect(200);
            }));
        });
        ...
        describe("update routes", () => {
            //update product;
            it("updates product for a user", () => __awaiter(void 0, void 0, void 0, function* () {
                const updateProductDetails = yield (0, supertest_1.default)(app_1.default)
        ...
        describe("delete routes", () => {
            it("delete product from a user", () => __awaiter(void 0, void 0, void 0, function* () {
                const _id = "638fb1a6470e38f51ba5bef2";
                yield (0, supertest_1.default)(app_1.default).delete(`/users/delete/${_id}`);
                expect(200);
            }));
        });
    });
